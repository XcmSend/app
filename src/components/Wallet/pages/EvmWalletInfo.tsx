...
const chainList = import './evmChains.json') as NetworkInfo[];
  ...
  return <div className={'boxed-container'}>
    <div className={'evm-wallet-info-page'}>
      ...
      <div className='evm-wallet-info-page__section'>
        ...
        <div>
          <Button
            className='xcm-send-btn xcm-send-btn-small-size transaction-button'
      ...
      <div className='evm-wallet-info-page__section'>
        ...
        <div className='evm-wallet-transaction_row'>
          <Button
            className='xcm-send-btn xcm-send-btn-small-size max-w'
            onClick={signData}
          >Sign Data</Button>
        </div>
        <div className='evm-wallet-transaction_row'>
